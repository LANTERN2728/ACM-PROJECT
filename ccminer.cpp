...
#define PROGRAM_NAME		"ccminerARM"
...
int main(int argc, char *argv[])
{
	...
	printf("ARM/Android Crypto Mining \n");
	printf(" Version :1.1 \n");
	printf(" Thanks \n");
//	printf("*********************************************************************************************************\n");

	printf("\n      *** ACM PROJECT " PACKAGE_VERSION " for Android Crypto Miner by LANTERN2728 based on ccminer***\n\n");
